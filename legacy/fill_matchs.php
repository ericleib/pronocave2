...
if(isset($_POST['reset_table_matchs'])){
  $q = "DELETE FROM ".get_table_matchs();
...
if(isset($_POST['fill_table_matchs'])){
  ...
  mysql_query("SELECT * FROM ".get_table_matchs())
  ...
  foreach($lines as $line){
	...
	$datetime = "2021-".$month."-".$day." ".$hour.":".$minutes.":00";
	$q = "INSERT INTO ".get_table_matchs()."(id_team_A,id_team_B,poule,date)
